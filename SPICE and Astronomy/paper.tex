...
Despite its ubiquitous adoption, SPICE is routinely employed in astronomical literature without exposing the underlying geometric assumptions, limiting reproducibility and error accountability. Specifically, the mathematical models, interpolation schemes, and coordinate conventions embedded in SPICE kernels are rarely disclosed in observational papers, even though errors arising from geometric simplifications, boundary condition violations, and numerical truncation can propagate systematically into final scientific inferences (Pajusalu \etal 2022). Furthermore, a point of minor confusion exists in interdisciplinary nomenclature: in electrical engineering, ``SPICE'' refers to the Simulation Program with Integrated Circuit Emphasis, a circuit simulation tool (Miranda 2024), whereas in observational astronomy and planetary science, SPICE represents the geometric information system designed by NAIF.
