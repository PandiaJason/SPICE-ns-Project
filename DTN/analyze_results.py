...
LABELS = {'cgr': 'Standard CGR', 'ecgr': 'Baseline ECGR', 'pecgr': 'Proposed P-ECGR'}
...
def fig_drop_reasons(agg, out):
    ...
    ax.set_xticks([0,1,2]); ax.set_xticklabels(['Standard CGR','Baseline ECGR','Proposed P-ECGR'])
...
def gen_table_results(agg, out):
    ...
    tex = '\\begin{table*}[t]\n\\centering\n\\caption{Comparative Performance: CGR vs.\\ Baseline ECGR vs.\\ Proposed P-ECGR}\n'
    tex += '\\label{tab:results}\n\\begin{tabular*}{\\textwidth}{@{\\extracolsep{\\fill}}llll}\n\\hline\n'
    tex += '\\textbf{Metric} & \\textbf{CGR} & \\textbf{Baseline ECGR} & \\textbf{Proposed P-ECGR} \\\\\n\\hline\n'
