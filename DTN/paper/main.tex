...
\title{An Energy-Aware, Contact-Graph Routing Optimization Strategy for Heterogeneous Deep Space SmallSat Relays}

\author{
\IEEEauthorblockN{Jason Pandian}
\thanks{Manuscript submitted for double-blind peer review. Primary correspondence may be directed to the submission portal.}
}
...
\begin{IEEEkeywords}
Delay-tolerant networking, contact graph routing, deep space communications, SmallSat, energy-aware routing, Mars relay network
\end{IEEEkeywords}
...
\begin{itemize}
    ...
    \textsf{\item} We propose \pecgr{}, a routing algorithm that incorporates future solar-charging predictions and a local energy booking registry to prevent energy overbooking and balance traffic load.
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{../figures/fig8_topology.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{../figures/fig1_delivery_ratio.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{../figures/fig2_smallsat_soc.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{../figures/fig3_smallsat_buffer.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{../figures/fig4_latency_cdf.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{../figures/fig5_cumulative_delivery.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{../figures/fig6_drop_reasons.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{../figures/fig7_dual_energy.pdf}
...
The authors thank NASA JPL for making the ION-DTN implementation and SPICE toolkit publicly available.
