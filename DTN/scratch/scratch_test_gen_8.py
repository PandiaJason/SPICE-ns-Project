...
# Modify SmallSat parameters: Battery=16Wh, Gen=8W, Rate=500kbps
NODE_SPECS[SMALLSAT]["battery_capacity_wh"] = 16.0
NODE_SPECS[SMALLSAT]["power_generation_w"] = 8.0
CONTACT_PARAMS[(SMALLSAT, DSN)]["data_rate_bps"] = 5e5

print("Running simulation with Battery=16Wh, Gen=8W, Rate=500kbps + Loop Prevention:")
base_seed = 42
