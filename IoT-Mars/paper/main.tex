...
\author{Jason~Pandian and I.~Kala%
\thanks{Jason Pandian is with the Department of Information Technology, Nehru Institute of Technology, Coimbatore, Tamil Nadu, India (e-mail: pandiajason@gmail.com).}%
\thanks{I. Kala is with the Department of Computer Science and Engineering, Nehru Institute of Technology, Coimbatore, Tamil Nadu, India.}}
...
\begin{IEEEkeywords}
LoRaWAN, Martian Communications, Chirp Spread Spectrum, Satellite Constellation, Dust Storm Fading, Temperature Oscillations, TCXO Drift.
\end{IEEEkeywords}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=1.0\columnwidth]{figures/martian_lorawan_topology.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\columnwidth]{figures/link_budget_analysis.png}
...
\label{tab:mc_params}
\centering
\begin{tabular}{p{4.8cm}|p{4.2cm}|p{7.5cm}}
\hline
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.95\columnwidth]{figures/pdr_vs_density.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.95\columnwidth]{figures/energy_vs_density.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.95\columnwidth]{figures/pdr_vs_distance.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.95\columnwidth]{figures/diurnal_performance.png}
...
\hline
Impedance mismatch loss & $4.0\text{ dB}$ (severe detuning + ohmic loss) & $0.5\text{ dB}$ (residual dielectric insertion loss only) \\
\hline
Dominant degradation mechanism & Resistive dust layer + resonance detuning & Thin low-loss dielectric film \\
\hline
\end{tabular}
\end{table}
