...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{ptb_arch_fig.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{ptb_fsm_fig.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{ptb_ptpu_fig.pdf}
